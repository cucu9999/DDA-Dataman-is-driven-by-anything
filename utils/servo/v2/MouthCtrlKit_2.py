...
mouthUpperUpLeft     = Servo(13, 90, 162, 67, 11.1, 0, 0, 1) #左上唇
mouthUpperUpRight    = Servo( 6, 90, 112, 18, 11.1, 0, 0, 0) #右上唇
mouthLowerDownLeft   = Servo( 5, 90, 126, 81, 11.1, 0, 0, 0) #左下唇
mouthLowerDownRight  = Servo(14, 90,  99, 54, 11.1, 0, 0, 1) #右下唇
 
mouthCornerUpLeft    = Servo( 0, 90, 117,  0, 11.1, 0, 0, 1) #左微笑上
mouthCornerUpRight   = Servo( 8, 90, 160, 63, 11.1, 0, 0, 0) #右微笑上
mouthCornerDownLeft  = Servo(12, 90, 135, 45, 11.1, 0, 0, 1) #左微笑下
mouthCornerDownRight = Servo( 7, 90, 135, 45, 11.1, 0, 0, 0) #右微笑下

jawFrontLeft         = Servo( 2, 90, 120, 90, 11.1, 0, 0, 0) #左下颚提
...
class MouthCtrl(Serial):
    ...
    def __init__(self, arg, *args, **kwargs):
        ...
        self.mouthUpperUpLeft     = 0.76
        self.mouthUpperUpRight    = 0.76
        self.mouthLowerDownLeft   = 0.2
        self.mouthLowerDownRight  = 0.2

        self.mouthCornerUpLeft    = 0.23
        self.mouthCornerUpRight   = 0.23
...
if __name__ == '__main__':
    ...
    ctrl.mouthUpperUpLeft     = 0.76
    ctrl.mouthUpperUpRight    = 0.76
    ...
    ctrl.jawFrontLeft         = 0.0
    ctrl.jawFrontRight        = 0.0
